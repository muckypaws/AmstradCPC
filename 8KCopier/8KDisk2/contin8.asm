;
         ORG  #3000                     ; Alternative DDFDC Commands
         ENT  $                         ; Version 9.89
         DI   
         CALL motoron
pause
...
wendwrit
         ...
         RET                            ; Exit Routine
;
writ8                                   ; Entry HL=DATA ADDR D=TRK E=DRV C=SECT
         PUSH af
         PUSH bc
         PUSH de
         PUSH hl                        ; Preserve Registers
...
ddfdcw3
         ...
         RET                            ; Quit 
;
fd8wri                                  ; DDFDC Write Into Data Register
         PUSH de                        ; Preserve DE
         LD   de,#1000
         LD   bc,#fb7e                  ; Point To MAIN STATUS REG
         LD   a,(drive)
...
fd82
         ...
         JR   z,fd84
         IN   a,(c)
         JP   p,fd82                    ; If Drive Not Ready Loop ddfdcw2
         AND  #20
fd83
         JR   nz,fd81                   ; Is All Output Finished ?
fd84
         PUSH bc
         LD   bc,#fa7e
         XOR  a
