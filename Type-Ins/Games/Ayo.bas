...
260 n0=160:n1=10:FOR l0=0 TO 5:hxy(0,l0,0)=n0:hxy(0,l0,1)=104:hxy(1,l0,0)=n0:hxy(1,l0,1)=248:hnum(1,l0,0)=n1:hnum(1,l0,1)=7:hnum(0,l0,0)=n1:hnum(0,l0,1)=22:n0=n0+64:n1=n1+4:NEXT
...
570 seed(turn)=seed(turn)+h(n0,n1):x0=hxy(n0,n1,0):y0=hxy(n0,n1,1):r0=rh:GOSUB 1150:GOSUB 970:FOR l0=1 TO h(n0,n1):n7=turn:n6=n1:n1=-1:GOSUB 1060:n1=n6:GOSUB 1180:tm=0.3:GOSUB 1210:NEXT:h(n0,n1)=0
...
720 PEN 1:PRINT TAB(7)CHR$(219)l$TAB(6)CHR$(222)CHR$(219)l$TAB(5)CHR$(217)CHR$(220)CHR$(219)l$TAB(4)CHR$(222)CHR$(217)" "CHR$(219)l$TAB(4)CHR$(207)CHR$(217)CHR$(222)CHR$(219)l$" "CHR$(222)CHR$(207)CHR$(207)CHR$(217)CHR$(220)
730 PRINT CHR$(222)CHR$(223)" "CHR$(7)CHR$(217)l$CHR$(207)CHR$(207)CHR$(223)CHR$(220)l$CHR$(207)CHR$(221)CHR$(220)l$CHR$(207)l$CHR$(220)
...
810 PEN 3:FOR l0=0 TO 7:LOCATE 8-l0,6+l0:PRINT CHR$(214)STRING$(l0,CHR$(143))STRING$(24,CHR$(143))STRING$(l0,CHR$(143))CHR$(215):NEXT
...
850 PEN 1:LOCATE 1,25:PRINT"I";:PEN 2:PRINT"nstructions";:PEN 1:PRINT" C";:PEN 2:PRINT"omputer";:PEN 1:PRINT" R";:PEN 2:PRINT"esign";:PEN 1:PRINT" S";:PEN 2:PRINT"tart-Again";
860 RETURN
870 ' Empty houses
...
920 RETURN
930 ' Fill houses
940 FOR l0=0 TO 1:FOR l1=0 TO 5:l2=1:WHILE l2<=h(l0,l1):l2=l2+1:n0=l0:n1=l1:GOSUB 1060:WEND:NEXT:l2=1:WHILE l2<=seed(l0):l2=l2+1:n7=l0:n1=-1:GOSUB 1060:WEND:NEXT
950 RETURN
960 ' Draw a house
