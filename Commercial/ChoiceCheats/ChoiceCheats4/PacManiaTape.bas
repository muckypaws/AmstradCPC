...
46 DATA XX
47 DATA "Hello Again, Sorry For The Delay. Please Insert Your Pacmania Cassette And Press Play.","When You Are Ready Press Space."
48 DATA XX
49 DATA F3,31,00,C0,01,C0,7F,ED,49,CD,37,BD,3E,FF,CD,6B,BC,06,00,11,00,01,CD
50 DATA 77,BC,EB,CD,83,BC,CD,7A,BC,21,37,A0,11,40,00,ED,53,05,01,01,40,00,ED
51 DATA B0,21,00,01,0E,FF,CD,16,BD,21,00,C3,22,AF,18,C3,84,03
