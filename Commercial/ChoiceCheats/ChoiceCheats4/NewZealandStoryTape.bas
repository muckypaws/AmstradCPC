...
15 RESTORE 49:FOR i=&BE80 TO &BEE0:READ a$:POKE i,VAL("&"+a$):NEXT:RESTORE 47:PEN 3:PRINT:GOSUB 19
...
46 DATA XX
47 DATA "Hello Again, Sorry For The Delay. Please Insert Your NEWZEALAND STORY Cassette And Press Play.","When You Are Ready Press Space."
48 DATA XX
...
52 DATA A8,11,AB,00,CD,47,A8,21,D5,BE,22,61,A9,C3,E2,A8,21,00,00,22,38,7E,22
53 DATA 39,7E,C3,00,9C
