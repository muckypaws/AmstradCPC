10 ' The Race Against Time Cheat Mode
...
15 RESTORE 49:FOR i=&BE80 TO &BEC6:READ a$:POKE i,VAL("&"+a$):NEXT:RESTORE 47:PEN 3:PRINT:GOSUB 19
...
41 DATA "THE RACE AGAINST TIME - Cheat Mode"
42 DATA "(C) 1989 1st Choice Software."
43 DATA XX
44 DATA "This Cheat For Codemasters'","Race Against Time Will Stop The Clock For You."
45 DATA "Please Wait Whilst I Set Up The Cheat"
46 DATA XX
47 DATA "Hello Again, Sorry For The Delay. Please Insert Your RACE AGAINST TIME Cassette And Press Play.","When You Are Ready Press Space."
48 DATA XX
...
51 DATA 3E,C3,21,C0,BE,32,37,BD,22,38,BD,21,FF,AB,11,40,00,C9,AF,32,0C,90,C3
52 DATA 3A,BD
