...
15 RESTORE 49:FOR i=&BE80 TO &BED2:READ a$:POKE i,VAL("&"+a$):NEXT:RESTORE 47:PEN 3:PRINT:GOSUB 19
...
41 DATA "SUPER STUNTMAN - Cheat Mode"
42 DATA "(C) 1989 1st Choice Software."
43 DATA XX
44 DATA "This Cheat For Codemasters'","Super Stuntman Gives You Infinite Lives & Time."
45 DATA "Please Wait Whilst I Set Up The Cheat"
46 DATA XX
47 DATA "Hello Again, Sorry For The Delay. Please Insert Your SUPER STUNTMAN Cassette And Press Play.","When You Are Ready Press Space."
48 DATA XX
...
52 DATA 11,40,00,C9,AF,32,A6,6F,32,BB,8B,C3,3A,BD
