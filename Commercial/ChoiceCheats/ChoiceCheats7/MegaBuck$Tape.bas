...
15 RESTORE 49:FOR i=&BE80 TO &BEDA:READ a$:POKE i,VAL("&"+a$):NEXT:RESTORE 47:PEN 3:PRINT:GOSUB 19
...
41 DATA "MEGABUCK$ - Cheat Mode"
42 DATA "(C) 1989 1st Choice Software."
43 DATA XX
44 DATA "This Cheat For Firebirds","Megabuck$ Gives You Infinite Energy & Phone Card Credits."
45 DATA "Please Wait Whilst I Set Up The Cheat"
46 DATA XX
47 DATA "Hello Again, Sorry For The Delay. Please Insert Your Megabuck$ Cassette And Press Play.","When You Are Ready Press Space."
48 DATA XX
...
52 DATA 00,22,38,BD,CD,37,BD,3E,01,CD,0E,BC,21,00,00,22,3F,6F,22,83,55,C9
