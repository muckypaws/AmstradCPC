10 ' Fruit Machine Simulator Cheat Mode
...
41 DATA "FRUIT MACHINE SIMULATOR - Cheat Mode"
42 DATA "(C) 1989 1st Choice Software."
43 DATA XX
44 DATA "This Cheat For Codemasters'","Fruit Machine Simulator Gives You Infinite Money For All Players."
45 DATA "Please Wait Whilst I Set Up The Cheat"
46 DATA XX
47 DATA "Hello Again, Sorry For The Delay. Please Insert Your FRUIT MACHINE SIMULATOR Cassette And Press Play.","When You Are Ready Press Space."
48 DATA XX
...
51 DATA 3E,C3,21,C0,BE,32,37,BD,22,38,BD,21,FF,AB,11,40,00,C9,AF,32,9E,75
