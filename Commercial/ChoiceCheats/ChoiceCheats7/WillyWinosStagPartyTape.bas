10 ' Willy Wino's Stag Party (Mr Wino.) Cheat Mode
...
41 DATA "WILLY WINO'S STAG PARTY - Cheat Mode"
42 DATA "(C) 1989 1st Choice Software."
43 DATA XX
44 DATA "This Cheat For Silverbirds","Willy Wino's Stag Party Gives You Infinite Lives & Allows You To Walk Through Nasties."
45 DATA "Please Wait Whilst I Set Up The Cheat"
46 DATA XX
47 DATA "Hello Again, Sorry For The Delay. Please Insert Your MR WINO Cassette And Press Play.","When You Are Ready Press Space."
48 DATA XX
...
52 DATA 00,22,38,BD,CD,37,BD,21,D6,BE,22,8E,86,AF,C3,0E,BC,21,00,00,22,39,17
53 DATA 22,3A,17,3E,03,32,97,20,3E,C3,32,8A,16,C3,00,01
...
58 CLS:LOCATE 16,2:PEN 1:PRINT"WILLY WINO":LOCATE 16,3:PRINT"----------"
