10 ' Dizzy III Fast Food Cheat Mode
...
15 RESTORE 49:FOR i=&BE80 TO &BECB:READ a$:POKE i,VAL("&"+a$):NEXT:RESTORE 47:PEN 3:PRINT:GOSUB 19
...
41 DATA "FAST FOOD (DIZZY) - Cheat Mode"
42 DATA "(C) 1989 1st Choice Software."
43 DATA XX
44 DATA "This Cheat For Codemasters'","Fast Food Will Give You Infinite Lives + The Ability To Select All 30 Levels."
45 DATA "Please Wait Whilst I Set Up The Cheat"
46 DATA XX
47 DATA "Hello Again, Sorry For The Delay. Please Insert Your FAST FOOD Cassette And Press Play.","When You Are Ready Press Space."
48 DATA XX
...
51 DATA 3E,C3,21,C0,BE,32,37,BD,22,38,BD,21,FF,AB,11,40,00,C9,AF,32,0C,57,3E
52 DATA 1E,32,98,05,C3,3A,BD
