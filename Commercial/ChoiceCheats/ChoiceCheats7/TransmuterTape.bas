...
15 RESTORE 49:FOR i=&BE80 TO &BEF2:READ a$:POKE i,VAL("&"+a$):NEXT:RESTORE 47:PEN 3:PRINT:GOSUB 19
...
41 DATA "TRANSMUTER - Cheat Mode"
42 DATA "(C) 1989 1st Choice Software."
43 DATA XX
44 DATA "This Cheat For Codemasters'","Transmuter Gives You Infinite Lives."
45 DATA "Please Wait Whilst I Set Up The Cheat"
46 DATA XX
47 DATA "Hello Again, Sorry For The Delay. Please Insert Your TRANSMUTER Cassette And Press Play.","When You Are Ready Press Space."
48 DATA XX
49 DATA F3,31,00,C0,01,C0,7F,ED,49,21,91,BE,0E,FF,CD,16,BD,CD,37,BD,3E,FF,CD
50 DATA 6B,BC,11,00,10,43,CD,77,BC,EB,32,AC,BE,CD,83,BC,E5,CD,7A,BC,3E,00,CB
51 DATA 4F,28,E8,2A,38,BD,22,3B,BD,3E,C3,21,C9,BE,32,37,BD,22,38,BD,21,FF,AB
52 DATA 11,40,00,C9,AF,00,32,D2,28,CD,3A,BD,3E,0F,21,D9,BE,C3,BC,BC,07,01,01
53 DATA 08,01,02,03,FB,02,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00
