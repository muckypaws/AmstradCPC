...
17 PEN 1:MODE 1:a$="O.k. Here We Go...":GOSUB 22:CALL &BD37:LOAD"!":POKE &771A,201:CALL &7700:CALL &9000
18 END
19 ' Messages
...
41 DATA "SHANGHI KARATE - Cheat Mode"
42 DATA "(C) 1989 1st Choice Software."
43 DATA XX
44 DATA "This Cheat For Players Shanghi Karate Allows Player 1 To Continue When Your Energy Has Run Out."
45 DATA "Please Wait Whilst I Set Up The Cheat"
46 DATA XX
47 DATA "Hello Again, Sorry For The Delay. Please Insert Your SHANGHI KARATE Tape And Press Play.","When You Are Ready Press Space."
48 DATA XX
49 DATA 3E,C3,21,27,90,32,80,BE,22,81,BE,3E,8F,32,7F,41,3E,B3,32,CC
50 DATA 41,3E,F9,32,2C,42,3E,02,32,2B,42,21,05,40,0E,FF,C3,05,40,21
...
54 DATA AC,3E,C9,32,4F,0B,C3,14,AC
