10 ' Monte Carlo Casino Cheat Mode V1.0
...
15 RESTORE 49:FOR i=&BE80 TO &BECD:READ a$:POKE i,VAL("&"+a$):NEXT:RESTORE 47:PEN 3:PRINT:GOSUB 19
...
41 DATA "MONTE CARLO CASINO - Cheat Mode"
42 DATA "(C) 1989 1st Choice Software."
43 DATA XX
44 DATA "This Cheat For Code Masters' Monte Carlo Casino Gives You :-"
45 DATA "Infinite Money","But Make Sure You Have Enough If You Are Playing Poker For High Stakes !","Please Wait Whilst I Set Up The Cheat"
46 DATA XX
47 DATA "Hello Again, Sorry For The Delay. Please Insert Your MONTE CARLO CASINO Cassette And Press Play.","When You Are Ready Press Space."
48 DATA XX
...
51 DATA C3,21,C1,BE,32,37,BD,22,38,BD,21,FF,AB,11,40,00,C3,00,3A,AF,32,95,1E
52 DATA 21,00,00,22,78,1e,C3,3A,BD
