...
15 RESTORE 49:FOR i=&A000 TO &A04C:READ a$:POKE i,VAL("&"+a$):NEXT:RESTORE 47:PEN 3:PRINT:GOSUB 19
...
41 DATA "PACMANIA - Cheat Mode"
42 DATA "(C) 1989 1st Choice Software."
43 DATA XX
44 DATA "This Cheat For Grandslam's","Pacmania Gives You :-"
45 DATA "Infinite Lives","Please Wait Whilst I Set Up The Cheat"
46 DATA XX
47 DATA "Hello Again, Sorry For The Delay. Please Insert Your Pacmania Disquette In Drive A:","When You Are Ready Press Space."
48 DATA XX
49 DATA F3,31,00,C0,01,C0,7F,ED,49,21,FF,AB,11,40,00,0E,07,CD,CE,BC,21,4C,A0
50 DATA CD,D4,BC,79,22,4D,A0,32,4F,A0,21,00,01,11,00,00,0E,41,DF,4D,A0,21,43
51 DATA A0,11,40,00,ED,53,05,01,01,40,00,ED,B0,21,00,01,0E,FF,CD,16,BD,21,00
52 DATA C3,22,AF,18,C3,84,03,84
