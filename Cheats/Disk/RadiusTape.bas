...
15 RESTORE 49:FOR i=&9000 TO &906D:READ a$:POKE i,VAL("&"+a$):NEXT:RESTORE 47:PEN 3:PRINT:GOSUB 19
...
41 DATA "RADIUS - Cheat Mode"
42 DATA "(C) 1989 1st Choice Software."
43 DATA XX
44 DATA "This Cheat For Players Radius Gives You Infinite Lives And Also Fixes The Bug Which Crashes The Game After Playing It The Once."
45 DATA "Please Wait Whilst I Set Up The Cheat"
46 DATA XX
47 DATA "Hello Again, Sorry For The Delay. Please Insert Your RADIUS Tape And Press Play.","When You Are Ready Press Space."
48 DATA XX
...
54 DATA AC,AF,32,39,87,E1,31,FF,BF,E9
