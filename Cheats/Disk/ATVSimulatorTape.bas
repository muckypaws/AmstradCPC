...
15 RESTORE 49:FOR i=&5000 TO &508B:READ a$:POKE i,VAL("&"+a$):NEXT:RESTORE 47:PEN 3:PRINT:GOSUB 19
16 a$=INKEY$:IF a$<>" " THEN 16
17 PEN 1:MODE 1:a$="O.k. Here We Go...":GOSUB 22:FOR i=1 TO 3000:NEXT:FOR i=0 TO 4:INK i,0:NEXT:CALL &BC6B,1:CALL &5000
18 END
19 ' Messages
...
48 DATA XX
49 DATA F3,31,00,C0,CD,37,BD,3E,FF,CD,6B,BC,21,00,60,11,01,60,01,00
50 DATA 4A,36,00,ED,B0,06,00,11,00,10,CD,77,BC,EB,CD,83,BC,E5,CD,7A
51 DATA BC,21,6D,50,11,80,BE,01,00,01,ED,B0,21,4D,50,11,16,BD,01,03
52 DATA 00,ED,B0,21,40,00,11,41,00,01,BF,4F,36,00,ED,B0,C9,C3,80,BE
53 DATA 28,43,29,20,31,39,38,39,20,31,73,74,20,63,68,6F,69,63,65,20
54 DATA 53,6F,66,74,77,61,72,65,2E,F3,11,00,01,DD,21,B1,A7,CD,40,A7
55 DATA 21,94,BE,22,5A,A8,C3,DB,A7,21,66,37,36,C3,C3,00,04,00,00,00
